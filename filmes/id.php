...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <form class="d-flex" action="id.php" method="post">
    ...
    if (isset($_POST['pesquisa'])) {
        ...
        $url = "https://api.themoviedb.org/3/find/{search}?api_key={$APIKEY}&language=en-US&external_source=imdb_id";
        ...
        for ($x = 1; $x <= $total_pages; $x++) {
            $url_single = "https://api.themoviedb.org/3/find/{search}?api_key=&language=en-US&external_source=imdb_id";
                     ...
                     <div class='product-image'>
                        ...
                        <div class='info'>
                            ...
                            <ul>
                                ...
                                <ol><strong>Nota: </strong>$resultado->id</ol>
                            </ul>
                        </div>
                    </div>
                </div>";
